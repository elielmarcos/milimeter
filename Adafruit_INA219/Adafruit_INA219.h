...
public:
  ...
  void setCalibration_16V_400mA(uint32_t calValue = 20480);
  void setCalibration_16V_800mA(uint32_t calValue = 16384);
  void setCalibration_16V_1600mA(uint32_t calValue = 8192);
  void setCalibration_16V_3200mA(uint32_t calValue = 4096);
...
private:
  ...
  // The following multipliers are used to convert raw current, power and voltage Bus
  // values to A, V and W, taking into account the current config settings
  float ina219_currentMultiplier_mA;
  float ina219_powerMultiplier_mW;
  float ina219_BUSMultiplier_V;
  float ina219_shuntMultiplier_mV;
